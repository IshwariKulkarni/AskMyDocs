...
This PDF question-answering system was later used as a testbed to benchmark 3 small open-weight models under identical conditions. Refer /backend/EXPERIMENT_REPORT.md
